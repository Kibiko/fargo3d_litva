...
#define VYTEMP 4096L
#define VZTEMP 8192L
#define Y1_COMM 16384L 
#define Y2_COMM 32768L
#define Y3_COMM 65536L
#define Y4_COMM 131072L
#define LIC_COMM 262144L //18/11
#define GLCS_COMM 524288L //10/12
...
#ifdef DUSTY //Scale factors
#	ifdef CARTESIAN
#	 define H_X(i,j,k)	1.0
#	 define H_Y(i,j,k)	1.0
#	 define H_Z(i,j,k)	1.0
#	endif
#	ifdef CYLINDRICAL
#	 define H_X(i,j,k) ymed(j)	
#	 define H_Y(i,j,k)	1.0
#	 define H_Z(i,j,k)	1.0
#	endif
#	ifdef SPHERICAL
#	 define H_X(i,j,k) ymed(j)	
#	 define H_Y(i,j,k)	1.0
#	 define H_Z(i,j,k)	ymed(i)*sin(xmed(i))
#	endif
