...
ex real bj(int);
ex real ws(int);
ex real C_dust(real,real,real,real,real,real,real);
ex real muj(int);
ex real nuj(int);
ex real mu1j(int, int);
ex real nu1j(int, int);
ex real dx(real, real, real);
ex real dxx(real, real, real, real);
ex void cooling_cpu(real); 
ex void cooling(real); 
ex void RKL1_cpu(real); 
ex real calcDmax_cpu();
ex void naive_cpu();
ex void integrate_naive_cpu(real);
...
ex real Cd(real*, real*, real*, int,int,int);
ex real GradDDotGrad(real*,real*,real,int,int,int,int,int);
...
ex void RK2_cpu(real);
ex void RK2_cooling_cpu(real);


ex void init_var(char*, char*, int, int, char*);
ex void ComputeDustSourceFunction_cpu(int,int); 
ex void addCooling_cpu(real, int, int);
ex int calcSubsteps(real);
//end of DUSTY prototypes
